...
function BarChart(svgRef: React.RefObject<SVGSVGElement>){
    // const data= [12, 5, 6, 6, 9, 10,13,19,20,22,30,33,40,45,20]; // given d in data, returns the (ordinal) x-value
    // const x = [12, 5, 6, 6, 9, 10,13,19,20,22,30,33,40,45,20]; // given d in data, returns the (ordinal) x-value
    // const y = [12, 5, 6, 6, 9, 10,13,19,20,22,30,33,40,45,20]; // given d in data, returns the (quantitative) y-value
    ...
    // //const xDomain; // an array of (ordinal) x-values
    ...
    // const color = "stellblue"; // bar fill color
    // //const duration: initialDuration = 250; // transition duration, in milliseconds
    // const duration = 750;
    // //const delay: initialDelay = (_, i) => i * 20; // per-element transition delay, in milliseconds
